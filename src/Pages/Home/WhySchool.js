    ...
    <>
      ...
      <Grid item xs={12} md={6}>
        <Stack spacing={3} alignItems="flex-start" px={4}>
          <Typography sx={{ fontSize: 36 }}>Яагаад Ховд их сургууль</Typography>
          <Typography sx={{ fontSize: 16 }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua Ut enim
            ad minim veniam magna aliqua eiusmod tempor.
          </Typography>
          <Grid container>
            <Grid item xs={6}>
              ...
              <Stack direction="row" spacing={1}>
                <CheckIcon color="primary" fontSize="small" />
                <Typography sx={{ fontSize: 14 }}>Докторын зэрэг</Typography>
              </Stack>
            ...
            <Grid item xs={6}>
              <Stack direction="row" spacing={1}>
                <CheckIcon color="primary" fontSize="small" />
                <Typography sx={{ fontSize: 14 }}>Олон улсын төвүүд</Typography>
              </Stack>
              <Stack direction="row" spacing={1}>
                <CheckIcon color="primary" fontSize="small" />
                <Typography sx={{ fontSize: 14 }}>Дэлхийн оюутнууд</Typography>
              </Stack>
              <Stack direction="row" spacing={1}>
                <CheckIcon color="primary" fontSize="small" />
